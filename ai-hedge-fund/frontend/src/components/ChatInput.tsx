...
export function ChatInput({ onSubmit, placeholder = 'Check AAPL, Scan value stocks...' }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="relative">
      <div className="flex items-center gap-3 bg-surface-card border border-border rounded-xl px-4 py-3 focus-within:border-accent-blue transition-colors">
        ...
        />
        <kbd className="text-xs text-gray-600 bg-surface-elevated px-1.5 py-0.5 rounded font-mono">Enter</kbd>
      </div>
    </form>
  );
}
